...
""" NURBS curve demonstration script """
...
from parablade.CAD_functions import NurbsCurve
...
# W = np.ones((n + 1), dtype=complex)
W = np.asarray([1, 1, 2, 1, 1])
...
my_NURBS = NurbsCurve(P, W, p, U)
C = my_NURBS.get_NurbsCurve_value(u)
options = {'line': 'yes', 'control_points': 'yes'}
my_NURBS.plot_NurbsCurve(options)
