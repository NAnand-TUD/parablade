...
% view(280, 10); camlight('headlight'); lighting flat; view(-60,+10)
view(70, -30); camlight('headlight'); lighting flat; view(50,10)
...
% Save the figure
% export_fig(figure1,'./MATLAB_figures/triogen_full','-png','-r1000')
